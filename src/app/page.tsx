  ...
  "@graph": [
    {
      ...
      description: "Conciergerie de locations saisonnières haut de gamme entre le Rhône et les Alpilles, Provence.",
      url: "https://entre-rhone-alpilles.fr",
      telephone: "+33600000000",
      email: "contact@entre-rhone-alpilles.fr",
      address: { "@type": "PostalAddress", addressLocality: "Saint-Rémy-de-Provence", postalCode: "13210", addressCountry: "FR" },

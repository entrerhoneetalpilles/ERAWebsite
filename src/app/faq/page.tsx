...
const faqProprietaires = [
  { question: "Quels sont les honoraires de la conciergerie Entre Rhône et Alpilles ?", answer: "Nos honoraires sont de 20 à 25% des revenus locatifs nets générés, selon la formule choisie (Essentiel ou Premium). Pas de frais d'installation, pas de frais fixes, pas d'engagement minimum. Vous ne payez que sur vos revenus réels." },
  ...
  { question: "Puis-je résilier le contrat quand je veux ?", answer: "Oui. Notre contrat ne comporte aucun engagement de durée. Un préavis de 30 jours calendaires suffit, envoyé par email. Nous nous assurons que toutes les réservations en cours sont honorées avant la fin de la collaboration." },
  { question: "Comment sont reversés mes revenus ?", answer: "Vos revenus sont virés sur votre compte bancaire chaque mois, accompagnés d'un relevé détaillé de toutes les réservations (dates, montants, plateforme, commission ERA, frais de ménage). Transparence totale." },

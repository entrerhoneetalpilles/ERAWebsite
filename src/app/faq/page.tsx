...
const faqDestinations = [
  ...
  { question: "Y a-t-il des marchés provençaux dans la région ?", answer: "Saint-Rémy (mercredi, le plus grand), Arles (samedi, exceptionnel), Maussane (jeudi matin), Fontvieille (lundi), Les Baux (vendredi été), Tarascon (mardi), Villeneuve-lès-Avignon (jeudi)." },

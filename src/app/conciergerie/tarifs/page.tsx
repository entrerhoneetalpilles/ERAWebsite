...
export default function TarifsPage() {
  return (
    <div className="pt-20">
      ...
      <div className="bg-[var(--color-cream)] border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-start gap-3">
            <Info className="w-5 h-5 text-[var(--color-rhone)] flex-shrink-0 mt-0.5" aria-hidden="true" />
            <p className="text-sm text-gray-700">
              <strong className="text-gray-900">Notre modèle :</strong> vous percevez vos revenus locatifs directement depuis Airbnb, Booking.com, etc.
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-16">
            {formulas.map((f) => (
              <div key={f.id}
                ...
                <div className="text-xs text-gray-500 bg-[var(--color-cream)] rounded-xl p-4 mb-6 space-y-1.5">
